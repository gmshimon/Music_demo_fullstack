      ...
      <Card className="w-full max-w-md bg-gray-900/80 backdrop-blur-xl border-gray-700 shadow-2xl relative z-10">
        <CardHeader className="text-center">
          ...
          <p className="text-gray-400">
            Join MusicHub and start your journey
          </p>
        </CardHeader>
                ...
                <div className="mt-2 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-xs font-medium ${
                      getPasswordStrengthScore() < 2 ? 'text-red-400' :
                      getPasswordStrengthScore() < 4 ? 'text-yellow-400' : 'text-green-400'
                    }`}>
                  ...
                  <div className="grid grid-cols-2 gap-1 text-xs">
                    {[
                      ...
                      <div key={requirement.key} className="flex items-center space-x-1">
                        {passwordStrength[requirement.key] ? (
                          <Check size={12} className="text-green-400" />
                        ) : (
                          <X size={12} className="text-gray-500" />
                        )}
                        <span className={passwordStrength[requirement.key] ? 'text-green-400' : 'text-gray-500'}>
                          {requirement.text}
                        </span>
                      </div>
                    ))}
