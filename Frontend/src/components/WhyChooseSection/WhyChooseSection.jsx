...
const benefits = [
  {
    ...
    description:
      'Get detailed feedback from industry professionals who know what labels are looking for.'
  },
  {
    icon: Clock,
    title: 'Quick Response Times',
    description:
      'Receive feedback within 7-14 days. No more waiting months for a response.'
  },
  {
    icon: Globe,
    title: 'Connect with Major Platforms',
    description:
      'Direct connections to record labels, streaming platforms, and industry networks.'
  }
]
      ...
      <div className='container mx-auto px-4'>
        ...
        >
          ...
          <p className='text-xl text-gray-400 max-w-3xl mx-auto mb-12'>
            We're not just another submission platform. We're your gateway to
            the music industry, connecting talented artists with the
          ...
          <Card className='bg-gradient-to-r from-purple-900/50 to-cyan-900/50 border-purple-500/30 max-w-2xl mx-auto'>
            <CardContent className='p-8'>
              ...
              <p className='text-gray-300 mb-6'>
                Join thousands of artists who have already taken the first step
                toward their musical success.
              </p>
              <Button
